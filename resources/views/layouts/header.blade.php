<div class="page-header">
    <div class="header-wrapper row m-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul>
                                            <li class="ps-0"><a href="basic-template.html">Basic Email</a>
                                            </li>
                                            <li class="ps-0"><a href="email-header.html">Basic With Header</a>
                                            </li>
                                            <li class="ps-0"><a href="template-email.html">Ecomerce
                                                    Template</a></li>
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
            <ul class="nav-menus">
                ...
                <li class="cart-nav onhover-dropdown">
                    ...
                    <div class="cart-dropdown onhover-show-div">
                        ...
                        <ul>
                            ...
                            <li class="total">
                                <h6 class="mb-0">Order Total : <span class="f-right">$1000.00</span>
                                </h6>
                            </li>
                            <li class="text-center"><a class="d-block mb-3 view-cart f-w-700" href="cart.html">Go
                                    to your cart</a><a class="btn btn-primary view-checkout"
                ...
                <li class="onhover-dropdown"><i data-feather="message-square"></i>
                    <div class="chat-dropdown onhover-show-div">
                        ...
                        <ul class="py-0">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-2"
                                        src="../assets/images/user/14.png" alt="">
                                    <div class="media-body">
                                        <h6>Ain Chavez</h6>
                ...
                <li class="profile-nav onhover-dropdown p-0 me-0">
                    ...
                    <div class="media-body"><span>سجل دخول اولا</span>
                        <p class="mb-0 font-roboto">زائر <i class="middle fa fa-angle-down"></i></p>
                    </div>
                    @else 
                    <div class="media profile-media"><img class="b-r-10"
                        src="../assets/images/dashboard/profile.jpg" alt="">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li>          <a href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"> <i data-feather="log-in"> </i><span>تسجيل خروج</span></a>
        ...
        <script class="result-template" type="text/x-handlebars-template"><div class="ProfileCard u-cf">                        
                        ...
                        <div class="ProfileCard-realName">karar</div>
                        </div>
                        </div></script>
